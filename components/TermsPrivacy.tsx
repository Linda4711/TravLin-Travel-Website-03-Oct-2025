        ...
        >
          ...
          <div className="sticky top-0 bg-white border-b-2 border-orange-200 px-4 py-3 flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-gray-800">Customer Acceptance Form</h2>
                <p className="text-sm text-gray-600">Complete to proceed with booking</p>
              </div>
            </div>
            <button 
              onClick={onClose}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4">
          ...
          <div className="mb-4 p-3 bg-blue-100 border-l-4 border-blue-600 rounded-r-lg shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
              ...
              <a
                href="/TravLin Travel_Travel Information ONLY_JUL25.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center p-2 bg-white border-2 border-blue-500 rounded text-blue-700 hover:bg-blue-50 transition-colors text-sm font-medium"
              >
              ...
              <a
                href="/TravLin Travel_Customer Acceptance ONLY_JUL25.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center p-2 bg-white border-2 border-blue-500 rounded text-blue-700 hover:bg-blue-50 transition-colors text-sm font-medium"
              >
          ...
          <div className="text-sm leading-relaxed space-y-4">
            ...
            {/* Executive Summary - HIGH CONTRAST */}
            <div className="mb-6 p-4 bg-orange-50 border-l-4 border-orange-500 rounded-r-lg shadow-sm">
              ...
              <ul className="list-disc list-inside text-orange-700 space-y-2 text-base">
            ...
            {/* All Detailed Terms Content - IMPROVED SPACING & TEXT SIZE */}
            <div className="space-y-6 text-gray-800">
              <div className="border-l-4 border-blue-200 pl-4">
                <h4 className="text-lg font-bold text-blue-800 mb-3">Prices and Taxes</h4>
              ...
              <div className="border-l-4 border-blue-200 pl-4">
                <h4 className="text-lg font-bold text-blue-800 mb-3">Products</h4>
                <p className="text-base leading-relaxed">
              ...
              <div className="border-l-4 border-blue-200 pl-4">
                <h4 className="text-lg font-bold text-blue-800 mb-3">Fees and Surcharges</h4>
                <div className="space-y-3">
                  <p className="text-base leading-relaxed">
              ...
              <div className="border-l-4 border-blue-200 pl-4">
                <h4 className="text-lg font-bold text-blue-800 mb-3">Change and Cancellation Fees</h4>
                <div className="space-y-3">
                  <p className="text-base leading-relaxed">
              ...
              <div className="border-l-4 border-blue-200 pl-4">
                <h4 className="text-lg font-bold text-blue-800 mb-3">Refunds</h4>
                <div className="space-y-3">
                  <p className="text-base leading-relaxed">
              ...
              <div className="border-l-4 border-blue-200 pl-4">
                <h4 className="text-lg font-bold text-blue-800 mb-3">Deposits and Payments</h4>
                <div className="space-y-3">
                  <p className="text-base leading-relaxed">
              ...
              <div className="border-l-4 border-blue-200 pl-4">
                <h4 className="text-lg font-bold text-blue-800 mb-3">Information</h4>
                <p className="text-base leading-relaxed">
              ...
              <div className="border-l-4 border-blue-200 pl-4">
                <h4 className="text-lg font-bold text-blue-800 mb-3">Special Requirements</h4>
                <p className="text-base leading-relaxed">
              ...
              <div className="border-l-4 border-blue-200 pl-4">
                <h4 className="text-lg font-bold text-blue-800 mb-3">Frequent Flyer and Loyalty Programs</h4>
                <p className="text-base leading-relaxed">
              ...
              <div className="border-l-4 border-blue-200 pl-4">
                <h4 className="text-lg font-bold text-blue-800 mb-3">Travel Documents</h4>
                <p className="text-base leading-relaxed">
              ...
              <div className="border-l-4 border-blue-200 pl-4">
                <h4 className="text-lg font-bold text-blue-800 mb-3">Agency</h4>
                <p className="text-base leading-relaxed">
              ...
              <div className="border-l-4 border-blue-200 pl-4">
                <h4 className="text-lg font-bold text-blue-800 mb-3">Liability</h4>
                <p className="text-base leading-relaxed">
              ...
              <div className="border-l-4 border-blue-200 pl-4">
                <h4 className="text-lg font-bold text-blue-800 mb-3">Governing Law</h4>
                <p className="text-base leading-relaxed">
              ...
              <div className="border-l-4 border-blue-200 pl-4">
                <h4 className="text-lg font-bold text-blue-800 mb-3">Summary of Obligations</h4>
                <p className="text-base leading-relaxed mb-3">Before making a booking, it is important that you meet the following requirements:</p>
              ...
              <div className="border-l-4 border-blue-200 pl-4">
                <h4 className="text-lg font-bold text-blue-800 mb-3">Definitions</h4>
              ...
              <div className="pt-6 border-t-2 border-gray-300">
                ...
                <div className="border-l-4 border-orange-200 pl-4 mb-4">
                  <h4 className="text-base font-bold text-orange-800 mb-3">Your personal information</h4>
                  <div className="space-y-3">
                ...
                <div className="border-l-4 border-orange-200 pl-4 mb-4">
                  <h4 className="text-base font-bold text-orange-800 mb-3">Marketing</h4>
                  <div className="space-y-3">
                    <p className="text-sm leading-relaxed">
                ...
                <div className="border-l-4 border-orange-200 pl-4 mb-4">
                  <h4 className="text-base font-bold text-orange-800 mb-3">Privacy Complaints</h4>
                  <p className="text-sm leading-relaxed">
                ...
                <div className="border-l-4 border-orange-200 pl-4 mb-4">
                  <h4 className="text-base font-bold text-orange-800 mb-3">Privacy Officer Contact</h4>
              ...
              <div className="pt-6 border-t-2 border-gray-300">
                <div className="border-b-2 border-orange-600 pb-3 mb-4">
                  <h3 className="text-lg font-bold text-gray-900">Complaints Handling Policy and Procedures</h3>
                </div>
                
                <div className="border-l-4 border-orange-200 pl-4 mb-4">
                  <h4 className="text-base font-bold text-orange-800 mb-3">Objective of the Policy</h4>
                  <div className="space-y-3">
                    <p className="text-sm leading-relaxed">
                ...
                <div className="border-l-4 border-orange-200 pl-4 mb-4">
                  <h4 className="text-base font-bold text-orange-800 mb-3">Definition of a Complaint</h4>
                  <p className="text-sm leading-relaxed">
                ...
                <div className="border-l-4 border-orange-200 pl-4 mb-4">
                  <h4 className="text-base font-bold text-orange-800 mb-3">How a complaint can be made</h4>
                  <div className="space-y-3">
                    <p className="text-base leading-relaxed">
                ...
                <div className="border-l-4 border-orange-200 pl-4 mb-4">
                  <h4 className="text-base font-bold text-orange-800 mb-3">The information you will need to tell us</h4>
                  <div className="space-y-3">
                    <p className="text-sm leading-relaxed">
                ...
                <div className="border-l-4 border-orange-200 pl-4 mb-4">
                  <h4 className="text-base font-bold text-orange-800 mb-3">Help when making a complaint</h4>
                  <p className="text-sm leading-relaxed">
                ...
                <div className="border-l-4 border-orange-200 pl-4 mb-4">
                  <h4 className="text-base font-bold text-orange-800 mb-3">Recording complaints</h4>
                  <div className="space-y-3">
                    <p className="text-sm leading-relaxed">
                ...
                <div className="border-l-4 border-orange-200 pl-4 mb-4">
                  <h4 className="text-base font-bold text-orange-800 mb-3">Feedback to customers</h4>
                  <div className="space-y-3">
                    <p className="text-sm leading-relaxed">
                ...
                <div className="border-l-4 border-orange-200 pl-4 mb-4">
                  <h4 className="text-base font-bold text-orange-800 mb-3">Our six-point complaint process</h4>
                ...
                <div className="border-l-4 border-orange-200 pl-4 mb-4">
                  <h4 className="text-base font-bold text-orange-800 mb-3">When you complain about one of our employees</h4>
                  <div className="space-y-3">
                    <p className="text-sm leading-relaxed">
                ...
                <div className="border-l-4 border-orange-200 pl-4 mb-4">
                  <h4 className="text-base font-bold text-orange-800 mb-3">Complaints under investigation by a regulator or law enforcement agency</h4>
                  <p className="text-sm leading-relaxed">
                ...
                <div className="border-l-4 border-orange-200 pl-4 mb-4">
                  <h4 className="text-base font-bold text-orange-800 mb-3">Our complaint escalation process</h4>
                  <div className="space-y-3">
                    <p className="text-sm leading-relaxed">
                ...
                <div className="border-l-4 border-orange-200 pl-4 mb-4">
                  <h4 className="text-base font-bold text-orange-800 mb-3">ATIA Travel Accreditation Scheme (ATAS)</h4>
                  <div className="space-y-3">
                    <p className="text-sm leading-relaxed">
                ...
                <div className="border-l-4 border-orange-200 pl-4">
                  <h4 className="text-base font-bold text-orange-800 mb-3">Your rights under Australian Consumer Law</h4>
                  <p className="text-sm leading-relaxed">
        ...
        {/* Sticky Footer - Ready to Proceed - ORANGE THEME */}
        <div className="flex-shrink-0 bg-orange-100 border-t-2 border-orange-300 p-4 shadow-lg">
          <div className="text-center">
            <div className="flex items-center justify-center mb-2">
              <CheckCircle className="w-5 h-5 text-orange-600 mr-2" />
              <h3 className="text-base font-bold text-orange-800">Ready to Proceed with Your Booking?</h3>
            </div>
