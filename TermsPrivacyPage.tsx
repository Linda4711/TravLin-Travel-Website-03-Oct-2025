...
const TermsPrivacyPage: React.FC<TermsPrivacyPageProps> = ({
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Main Content - SINGLE PAGE WITH EMBEDDED FORM */}
      <main className="content-container py-2 md:py-4" style={{ paddingTop: '70px' }}>
        <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-2xl">
          ...
          <div className="bg-white border-b-2 border-blue-200 px-3 md:px-4 py-2 md:py-3 flex items-center justify-center shadow-sm">
            <div className="w-7 h-7 md:w-8 md:h-8 bg-blue-600 rounded-full flex items-center justify-center shadow-md mr-3">
          ...
          {/* Scrollable Content - CONSISTENT SMALL TEXT THROUGHOUT */}
          <div className="px-3 md:px-4 py-2 md:py-3 max-h-[60vh] md:max-h-[65vh] overflow-y-auto">
            {/* Document Downloads - COMPACT */}
            <div className="mb-2 p-2 bg-blue-100 border-l-4 border-blue-600 rounded-r-lg shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-1.5">
                ...
                >
                  <FileText className="w-3 h-3 mr-0.5 flex-shrink-0" />
                  <span className="text-center text-xs">Customer Acceptance Form</span>
                </a>
              </div>
            </div>

            {/* Terms & Conditions Content - CONSISTENT SMALL TEXT */}
            <div className="text-xs leading-snug space-y-2">
              <div className="border-b-2 border-blue-600 pb-1.5 mb-2">
                <h2 className="text-sm md:text-base font-bold text-gray-900 mb-1.5">Terms & Conditions</h2>
              </div>
              
              <p className="mb-2 text-gray-800 text-xs leading-snug">
              ...
              {/* Executive Summary */}
              <div className="mb-2 p-2 bg-orange-50 border-l-4 border-orange-500 rounded-r-lg">
                <h3 className="text-xs font-bold text-orange-800 mb-1">
                  Executive Summary
                </h3>
                <p className="text-orange-700 mb-1 text-xs leading-snug">
                  Although you should read all of the terms and conditions, the following is a summary of the most important:
                </p>
                <ul className="list-disc list-inside text-orange-700 space-y-0.5 text-xs leading-snug">
              ...
              {/* All Detailed Terms Content - CONSISTENT SMALL TEXT */}
              <div className="space-y-2 text-gray-900">
                <div className="border-l-4 border-blue-200 pl-2">
                  <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-blue-600 transition-colors duration-300 mb-1 cursor-pointer">Prices and Taxes</h4>
                ...
                <div className="border-l-4 border-blue-200 pl-2">
                  <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-blue-600 transition-colors duration-300 mb-1 cursor-pointer">Products</h4>
                  <p className="text-xs leading-snug">
                ...
                <div className="border-l-4 border-blue-200 pl-2">
                  <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-blue-600 transition-colors duration-300 mb-1 cursor-pointer">Change and Cancellation Fees</h4>
                  <div className="space-y-1">
                    <p className="text-xs leading-snug">
                ...
                <div className="border-l-4 border-blue-200 pl-2">
                  <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-blue-600 transition-colors duration-300 mb-1 cursor-pointer">Refunds</h4>
                  <div className="space-y-1">
                    <p className="text-xs leading-snug">
                ...
                <div className="border-l-4 border-blue-200 pl-2">
                  <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-blue-600 transition-colors duration-300 mb-1 cursor-pointer">Frequent Flyer and Loyalty Programs</h4>
                  <p className="text-xs leading-snug">
                ...
                <div className="border-l-4 border-blue-200 pl-2">
                  <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-blue-600 transition-colors duration-300 mb-1 cursor-pointer">Liability</h4>
                  <p className="text-xs leading-snug">
                ...
                <div className="border-l-4 border-blue-200 pl-2">
                  <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-blue-600 transition-colors duration-300 mb-1 cursor-pointer">Summary of Obligations</h4>
                  <p className="text-xs leading-snug mb-1">Before making a booking, it is important that you meet the following requirements:</p>
                ...
                <div className="pt-2 border-t-2 border-gray-300">
                  ...
                  <div className="border-l-4 border-orange-200 pl-2 mb-2">
                    <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-orange-600 transition-colors duration-300 mb-1 cursor-pointer">Your personal information</h4>
                    <div className="space-y-1">
                      <p className="text-xs leading-snug">
                  ...
                  <div className="border-l-4 border-orange-200 pl-2 mb-2">
                    <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-orange-600 transition-colors duration-300 mb-1 cursor-pointer">Marketing</h4>
                    <div className="space-y-1">
                      <p className="text-xs leading-snug">
                  ...
                  <div className="border-l-4 border-orange-200 pl-2 mb-2">
                    <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-orange-600 transition-colors duration-300 mb-1 cursor-pointer">Privacy Complaints</h4>
                    <p className="text-xs leading-snug">
                  ...
                  <div className="border-l-4 border-orange-200 pl-2 mb-2">
                    <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-orange-600 transition-colors duration-300 mb-1 cursor-pointer">Privacy Officer Contact</h4>
                ...
                {/* Complaints Handling Policy - CONSISTENT SMALL TEXT */}
                <div className="pt-2 border-t-2 border-gray-300">
                  <div className="pb-1 mb-2">
                  ...
                  <div className="border-l-4 border-orange-200 pl-2 mb-2">
                    <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-orange-600 transition-colors duration-300 mb-1 cursor-pointer">Objective of the Policy</h4>
                    <div className="space-y-1">
                      <p className="text-xs leading-snug">
                      ...
                      <p className="text-xs leading-snug">
                        This policy applies to any individual, business or organization that has or seeks to have a business relationship with TravLin Travel. We are committed to a fair, timely and efficient complaint resolution process. We will inform you of this policy and the applicable procedures and ensure it is complied with. If you have a complaint, we want to know about it and work with you to resolve it. Please take the time to familiarize yourself with the following information on our complaints handling procedures.
                      </p>
                    </div>
                  </div>

                  <div className="border-l-4 border-orange-200 pl-2 mb-2">
                    <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-orange-600 transition-colors duration-300 mb-1 cursor-pointer">What is a complaint?</h4>
                    <p className="text-xs leading-snug">
                      A complaint is an expression of dissatisfaction made to us where a response is either explicitly or implicitly expected. If you contact us with a complaint, we will seek to address it directly in the first instance, at the time you contact us. We may also advise you of alternative ways of resolving your concerns if we are not the appropriate organisation to handle your complaint.
                    </p>
                  </div>

                  <div className="border-l-4 border-orange-200 pl-2 mb-2">
                    <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-orange-600 transition-colors duration-300 mb-1 cursor-pointer">How to make a complaint</h4>
                    <p className="text-xs leading-snug">
                      To make a complaint, you can contact TravLin Travel via email, telephone, letter or in person. When lodging a complaint, we will ask you to provide us with as much information as possible. This assists us to investigate and resolve your complaint. You should provide us with your contact details including your name and contact telephone number or email address. This allows us to contact you to clarify details or ask for more information and then ultimately respond to your complaint.
                    </p>
                  </div>

                  <div className="border-l-4 border-orange-200 pl-2 mb-2">
                    <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-orange-600 transition-colors duration-300 mb-1 cursor-pointer">Confidentiality and Privacy</h4>
                    <div className="space-y-1">
                      <p className="text-xs leading-snug">
                  ...
                  <div className="border-l-4 border-orange-200 pl-2 mb-2">
                    <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-orange-600 transition-colors duration-300 mb-1 cursor-pointer">Feedback to customers</h4>
                    <div className="space-y-1">
                      <p className="text-xs leading-snug">
                  ...
                  <div className="border-l-4 border-orange-200 pl-2 mb-2">
                    <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-orange-600 transition-colors duration-300 mb-1 cursor-pointer">Our six-point complaint process</h4>
                    <ul className="list-disc list-inside space-y-0.5 text-xs pl-2">
                  ...
                  <div className="border-l-4 border-orange-200 pl-2 mb-2">
                    <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-orange-600 transition-colors duration-300 mb-1 cursor-pointer">When you complain about one of our employees</h4>
                    <div className="space-y-1">
                      <p className="text-xs leading-snug">
                  ...
                  <div className="border-l-4 border-orange-200 pl-2 mb-2">
                    <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-orange-600 transition-colors duration-300 mb-1 cursor-pointer">Complaints under investigation by a regulator or law enforcement agency</h4>
                    <p className="text-xs leading-snug">
                  ...
                  <div className="border-l-4 border-orange-200 pl-2 mb-2">
                    <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-orange-600 transition-colors duration-300 mb-1 cursor-pointer">Our complaint escalation process</h4>
                    <div className="space-y-1">
                      <p className="text-xs leading-snug">
                  ...
                  <div className="border-l-4 border-orange-200 pl-2 mb-2">
                    <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-orange-600 transition-colors duration-300 mb-1 cursor-pointer">ATIA Travel Accreditation Scheme (ATAS)</h4>
                    <p className="text-xs leading-snug mb-1">Should you wish to speak to ATAS about your complaint you can contact them in the following ways:</p>
                    <ul className="list-disc list-inside space-y-0.5 text-xs pl-2">
                  ...
                  <div className="border-l-4 border-orange-200 pl-2 mb-2">
                    <h4 className="text-xs md:text-sm font-bold text-gray-900 hover:text-orange-600 transition-colors duration-300 mb-1 cursor-pointer">Your rights under Australian Consumer Law</h4>
                    <p className="text-xs leading-snug">
          ...
          {/* SCROLL INDICATOR - SUBTLE WITH ARROW */}
          <div className="bg-gradient-to-b from-blue-50 to-orange-50 border-t-2 border-blue-200 px-4 py-2 flex items-center justify-center">
            <div className="flex flex-col items-center animate-bounce">
              <p className="text-xs font-medium text-gray-700 mb-1">SCROLL</p>
